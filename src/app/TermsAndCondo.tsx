    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Color.Gray.gray600 }}>
      <View style={{ backgroundColor: Color.Gray.gray600, flex: 1 }}>
        ...
        <ScrollView style={styles.container}>
          ...
          <Text style={styles.paragraph}>Welcome to Lumi! {"\n"}</Text>
          <Text style={styles.paragraph}>
            ...
            Lumi’s features, ensuring it becomes the best experience possible
            for our entire community, including you!
          </Text>

          <Text style={styles.paragraph}>
            Here at Lumi, we value transparency with our users. So, please note
            that while using the Lumi Application, certain user data will be
            collected. To enable account creation and continued user access, it
            is necessary that user email data is collected. Additionally, user
            experience is unique to each location, which requires user location
            data to also be collected.
          </Text>
          ...
          <Text style={styles.paragraph}>
            ...
            birthday and profile picture. Opting-in allows us here at Lumi to
          ...
          <Text style={styles.paragraph}>
            ...
            can go to the privacy section of the settings menu and view the data
            collection options.
          </Text>
          <Text style={styles.paragraph}>
            ...
            parties. Numad Labs LLC, the developer of the Application, is not
            liable for any offers, rewards or any associated claims, damages or
            losses.
          </Text>

          <Text style={styles.paragraph}>
            One final note, to ensure security and smooth operations during the
            Pilot Program, some features will be limited. Specifically, you
            won’t be able to withdraw or transfer any bitcoin earned until the
            Pilot Program ends. We’ll notify all users via email and app
