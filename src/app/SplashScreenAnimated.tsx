    ...
    <View style={styles.container}>
      <View style={styles.animationContainer}>
        <View style={styles.animatedViewWrapper}>
          <Animated.View
            style={[styles.animatedView, styles.topPosition, animatedStyle1]}
          >
            <LinearGradient
              start={{ x: 0, y: 1 }}
              end={{ x: 1, y: 0 }}
          ...
          <Animated.View
            style={[styles.animatedView, styles.bottomPosition, animatedStyle2]}
          >
            <LinearGradient
              start={{ x: 0, y: 1 }}
              end={{ x: 1, y: 0 }}
...
const styles = StyleSheet.create({
  ...
  blurView: {
    ...
    justifyContent: "center",
    backgroundColor:
      Platform.OS === "ios" ? "rgba(27, 35, 40, 0.1)" : "rgba(27, 35, 40, 0.1)",
    overflow: "hidden",
    borderRadius: 32,
    alignItems: "center",
  },
