            ...
            <View style={{ flex: 1, backgroundColor: Color.Gray.gray600, alignItems: 'center' }}>
              ...
              >
                <LinearGradient
                  ...
                  style={[styles.button]}
                >
                    <Image source={require('../../public/images/pqr.png')} style={{ width: '100%', height: '100%'}}/> 
                </LinearGradient>
              </TouchableOpacity>
              <View style={{ marginTop: 32, marginHorizontal: 32 }}>
                <Text style={{ textAlign: 'center', fontSize: 14, lineHeight: 18, color: Color.Gray.gray100 }}>Show this to your waiter to Check-In. Do not worry, they are pros.</Text>
              </View>
